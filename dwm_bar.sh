...
. "$DIR/bar-functions/dwm_temperature.sh"
...
#    dispstr="$dispstr$(dwm_weather)"
    dispstr="$dispstr$(dwm_disk)$SEPM"
    dispstr="$dispstr$(dwm_ram)$SEPM"
    dispstr="$dispstr$(dwm_temperature)$SEPM"
    dispstr="$dispstr$(dwm_alsa)$SEPM"
    dispstr="$dispstr$(dwm_battery)$SEPM"
    dispstr="$dispstr$(dwm_date)$SEPM"
    dispstr="$dispstr$(dwm_time)"
